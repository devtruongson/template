                ...
                <div className="col-xl-5 col-lg-5">
                  <div className="ht-left_area">
                    <div className="header-shipping_area">
                      <span>
                        <strong>Đấu Giá Trang Sức</strong>
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-4 d-none d-lg-block">
                  <div className="hm-form_area">
                    <form action="#" className="hm-searchbox">
                      ...
                      <button className="umino-search_btn" type="submit">
                          ...
                          <ul className="cat-mega-menu">
                            ...
                            <li className="right-menu cat-mega-title">
                              ...
                              <ul>
                                ...
                                <li>
                                  <a href="#">Trang Sức Đính ECZ</a>
                                </li>
                                <li>
                                  <a href="#">
                                    Trang Sức Đính Đá Quý Và Bán Quý
                                  </a>
                                </li>
                                <li>
                                  <a href="#">Trang Sức Đính Ngọc Trai</a>
                                </li>
                                <li>
                                  <a href="#">Trang Sức Đính CZ</a>
                                </li>
                                <li>
                    ...
                    <nav className="main_nav">
                      <ul>
                        <li className="dropdown-holder">
                          <a href="#">
                            Tài sản đấu giá<i className="ion-chevron-down"></i>
                          </a>
                        ...
                        <li>
                          <a href="#">
                            Tin tức đấu giá<i className="ion-chevron-down"></i>
                          </a>
                          <ul className="hm-dropdown">
                            <li>
                              <a href="#">
                                Bài viết<i className="ion-chevron-right"></i>
                              </a>
                        ...
                        <li>
                          <a href="#">
                            Giới thiệu<i className="ion-chevron-down"></i>
                          </a>
                          <ul className="hm-dropdown">
                            <li>
                    ...
                    <nav className="main_nav">
                      <ul>
                        <li className="dropdown-holder">
                          ...
                          <ul className="hm-dropdown">
                            <li>
                              <a href="#">Trang chủ Cửa hàng1</a>
                            </li>
                            <li>
                              <a href="#">Trang chủ Cửa hàng 2</a>
                            </li>
                            <li>
                              <a href="#">Trang chủ Cửa hàng 3</a>
                            </li>
                            <li>
                              <a href="#">Trang chủ Cửa hàng 4</a>
                            </li>
                          </ul>
                        </li>
                        <li className="megamenu-holder">
                          <a href="#">
                            Cửa hàng<i className="ion-chevron-down"></i>
                          </a>
                          <ul className="umino-megamenu">
                            <li>
                              <span className="megamenu-title">
                                Bố cục trang cửa hàng
                              </span>
                              <ul>
                                <li>
                                  <a href="#">Toàn bộ chiều rộng lưới</a>
                                </li>
                                <li>
                                  <a href="#">Thanh bên trái</a>
                                </li>
                                <li>
                                  <a href="#">Thanh bên phải</a>
                                </li>
                                <li>
                                  <a href="#">Danh sách toàn chiều rộng</a>
                                </li>
                                <li>
                                  <a href="#">Danh sách có thanh bên trái</a>
                                </li>
                                <li>
                                  <a href="#">Danh sách có thanh bên phải</a>
                                </li>
                              </ul>
                            </li>
                            <li>
                              ...
                              <ul>
                                <li>
                                  <a href="#">Bộ sưu tập bên trái</a>
                                </li>
                                <li>
                                  <a href="#">Bộ sưu tập bên phải</a>
                                </li>
                                <li>
                                  <a href="#">Kiểu tab bên trái</a>
                                </li>
                                <li>
                                  <a href="#">Kiểu tab bên phải</a>
                                </li>
                                <li>
                                  <a href="#">Cố định bên trái</a>
                                </li>
                                <li>
                                  <a href="#">Cố định bên phải</a>
                                </li>
                              </ul>
                            </li>
                            <li>
                              ...
                              <ul>
                                <li>
                                  <a href="#">Sản phẩm đơn</a>
                                </li>
                                <li>
                                  <a href="#">Bán sản phẩm đơn</a>
                                </li>
                                <li>
                                  <a href="#">Nhóm sản phẩm duy nhất</a>
                                </li>
                                <li>
                                  <a href="#">Biến sản phẩm đơn</a>
                                </li>
                                <li>
                                  <a href="#">Liên kết sản phẩm duy nhất</a>
                                </li>
                                <li>
                                  <a href="#">Thanh trượt sản phẩm đơn</a>
                                </li>
                              </ul>
                            </li>
                            <li>
                              <span className="megamenu-title">
                                Trang liên quan đến cửa hàng
                              </span>
                              <ul>
                                <li>
                                  <a href="#">Tài khoản của tôi</a>
              ...
              <div className="col-lg-6">
                <div className="banner-item img-hover_effect">
                  ...
                  <div className="banner-content">
                    ...
                    <h4>..</h4>
                    <h3>...</h3>
                    <a className="umino-btn umino-btn_dark" href="#">
                      Đấu giá ngay
                    </a>
                  </div>
                </div>
                    ...
                    <div className="single-product">
                      <div className="product-img">
                        <a href="#">
                          <img
                            className="primary-img"
                            src="assets/images/product/medium-size/2-1.jpg"
                            alt="Umino's Product Image"
                          />
                        </a>
                        <div className="add-actions">
                    ...
                    <div className="single-product">
                      ...
                      <div className="product-content">
                        <div className="product-desc_info">
                          ...
                          <h6 className="product-name">
                            <a href="#">Bibenm lorem coectetur</a>
                          </h6>
                          <div className="rating-box">
                            <ul>
                              <li>
                    ...
                    <div className="single-product">
                      <div className="product-img">
                        <a href="#">
                          <img
                            className="primary-img"
                            src="assets/images/product/medium-size/4-1.jpg"
                            alt="Umino's Product Image"
                          />
                        </a>
                        <div className="add-actions">
                      ...
                      <div className="product-content">
                        <div className="product-desc_info">
                          ...
                          <h6 className="product-name">
                            <a href="#">Curabitur tristique neque</a>
                          </h6>
                          <div className="rating-box">
                            <ul>
                              <li>
                          ...
                          <div className="product-progressbar">
                            <span className="product-in_stock">
                              Available:<strong>369</strong>
                            </span>
                            <span className="product-sold">
                              Unit Sold:<strong>56</strong>
                            </span>
                          </div>
                          <div className="umino-countdown"></div>
                        </div>
                    ...
                    <div className="single-product">
                      <div className="product-img">
                        <a href="#">
                          <img
                            className="primary-img"
                            src="assets/images/product/medium-size/5-1.jpg"
                            alt="Umino's Product Image"
                          />
                        </a>
                        <div className="add-actions">
                      ...
                      <div className="product-content">
                        <div className="product-desc_info">
                          ...
                          <h6 className="product-name">
                            <a href="#">Accumsan mauris ullaat</a>
                          </h6>
                          <div className="rating-box">
                            <ul>
                              <li>
                          ...
                          <div className="product-progressbar">
                            <span className="product-in_stock">
                              Available:<strong>466</strong>
                            </span>
                            <span className="product-sold">
                              Unit Sold:<strong>37</strong>
                            </span>
                          </div>
                          <div className="umino-countdown"></div>
                        </div>
                    ...
                    <div className="single-product">
                      ...
                      <div className="product-content">
                        <div className="product-desc_info">
                          ...
                          <h6 className="product-name">
                            <a href="#">Auctor gravida enimuctor</a>
                          </h6>
                          <div className="rating-box">
                            <ul>
                              <li>
              ...
              <div className="col-lg-6">
                <div className="banner-item img-hover_effect">
                  ...
                  <div className="banner-content banner-content-2">
                    ...
                    <a className="umino-btn umino-btn_yellow" href="#">
                      Shop Now
                    </a>
                  </div>
                </div>
                    ...
                    <div className="single-product">
                      ...
                      <div className="product-content">
                        <div className="product-desc_info">
                          ...
                          <h6 className="product-name">
                            <a href="#">Aliquam porttitor turpis</a>
                          </h6>
                          <div className="rating-box">
                            <ul>
                              <li>
                    ...
                    <div className="single-product">
                      ...
                      <div className="product-content">
                        <div className="product-desc_info">
                          ...
                          <h6 className="product-name">
                            <a href="#">Condime eondim furnitur</a>
                          </h6>
                          <div className="rating-box">
                            <ul>
                              <li>
                  ...
                  <div className="footer-widgets footer-contact_info">
                    <ul>
                      ...
                      <li>
                        ...
                        <span>
                          Thứ Hai-Thứ Bảy 9:00 tối - 5:00 chiều. Chủ nhật: Đóng
                          cửa
                        </span>
                      </li>
                    </ul>
                    ...
                    <div className="latest-tweets_slider">
                      <div className="twitter-single_item">
                        <div className="twitter-feed_content">
                          <p>
                            With this roundup of 42 of the best halftone
                            resources for Adobe Photoshop and Adobe Illustrator,
                            here's everything you need to achieve that
                            classNameic vintage look for yourself.
                            <a
                              href="#"
                              title="enva.to/rd"
                              className="rtw_url_link"
                            >
                              enva.to/rd
                            </a>
                            <a
                              href="#"
                              title="pic.twitter.com/Xy55wIEP5T"
                              className="rtw_media_link"
                            >
                              {" "}
                              pic.twitter.com/Xy55wIEP5T
                            </a>
                          </p>
                        </div>
                      ...
                      <div className="twitter-single_item">
                        <div className="twitter-feed_content">
                          <p>
                            Packed with ideas, inspiration, and just a few
                            pictures of cute cats, it can be hard to stand out
                            in a sea of graphics on
                            <a href="#" title="Pinterest" lang="en">
                              @Pinterest
                            </a>
                            . Which is why we're here to help with these awesome
                            templates.
                            <a
                              href="#"
                              title="https://enva.to/r6"
                              className="rtw_url_link"
                            >
                              enva.to/r6
                            </a>
                ...
                <div className="modal-inner-area sp-area row">
                  <div className="col-lg-5">
                    <div className="sp-img_area">
                      <div
                        className="sp-img_slider-2 slick-img-slider umino-slick-slider arrow-type-two"
                        data-slick-options='{
                                                        "slidesToShow": 1,
                                                        "arrows": false,
                                                        "fade": true,
                      ...
                      <div
                        className="sp-img_slider-nav slick-slider-nav umino-slick-slider arrow-type-two"
                        data-slick-options='{
                                   "slidesToShow": 4,
